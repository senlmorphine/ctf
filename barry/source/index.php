...
$hint = "Post decode([Get-flag])  as fast as you can, then your will get flag";
...
if(isset($_POST['shellmates'])){
	if($_POST['shellmates'] === $_SESSION['random_string']){
		$cost = getMilliSecond() - $_SESSION['random_string_create_time'];
		if ($cost < 3000){
			echo "Wow, prefect! Here is the flag : MCSC{Im_sup3r_f4st}";
		}else{
		...
		echo '<input name="shellmates" type="text">';
