...
void business_call(struct person *p)
{
	...
	puts("------------------------------------------------------------");
	printf("Calling... %s\n", p->phone_number);
	printf("Salam %s", p->name);
	puts("Im sorry for my absence yesterday. i was sick");
	puts("------------------------------------------------------------");
}
...
void print_menu()
{
	...
	puts("1. Store information about someone");
	puts("2. Edit information");
	puts("3. Call someone");
	puts("4. remove someone");
	puts("5. Add a hidden_note");
	printf("> ");
}
